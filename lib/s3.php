...
* Amazon S3 PHP class
*
* Source: https://github.com/tpyo/amazon-s3-php-class/blob/master/S3.php
* @link http://undesigned.org.za/2007/10/22/amazon-s3-php-class
* @version 0.5.1
*
* Modifications have been made over the years as the Amazon APIs have been updated
*/
...
class S3Exception extends Exception {
    ...
    function __construct($message, $file, $line, $code = 0)
    {
        ...
        writeNote("S3 Class Error [$code] :: $message", true);
        $this->file = $file;
        $this->line = $line;
    }
}